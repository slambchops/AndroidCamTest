...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	private int mCamWidth = 640;
	private int mCamHeight = 480;
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			parameters.setPictureSize(mCamWidth, mCamHeight);
			parameters.setPreviewSize(mCamWidth, mCamHeight);
			mCamera.setParameters(parameters);
		} catch (NullPointerException e) {
			Log.e(TAG, "Error getting camera params: " + e.getMessage());
		}
